...
$selectedTaskID = $_SESSION['selectedTask'] ?? null;
unset($_SESSION['selectedTask']);
?>
...
<head>
    ...
    <link rel="stylesheet" href="6-projectGannt.css">
    <link rel="stylesheet" href="6-tasksDetailDialog.css">
...
<body>
            ...
            <div class="contentHolder">
                <section class="content" id="content">
                    <div class="leftNavPanel panel">
                        ...
                        <a class="leftNavPanelItem" href="6-projectMember.php">
                        ...
                        <a class="leftNavPanelItem active" href="6-projectGannt.php">
                    ...
                    <div class="rightCtnPanel">
                        <div class="ganntChart panel">
                            <h3>Gannt Chart</h3>
                            
                            <div class="ganntWrapper">
                                <div class="ganntHeaderPanel">
                                    ...
                                    <div class="ganntResizer"></div>
                                    <div class="timelineHeader"></div>
                                </div>

                                

                                <div class="ganntBodyPanel">
                                ...
                                <div class="ganntRangeButton">
                                    <button class="scrollTodayButton" onclick="scrollToToday()">Today</button>
                                    <div class="divisionLine"></div>
                                    <button class="timeRangeButton active" id="weekButton">Week</button>
    ...
    <dialog class="taskDetail" id="taskDetail">
        ...
        <div class="detailWrapper">
            <div class="mainDetail">
                <div class="taskTitleWrapper">
                    <input type="text" id="taskTitle" class="titleEdit">
                </div>
                <div class="taskDescription">
                    <div class="descriptionWrapper">
                        <div class="descriptionView" id="taskDescriptionView">
                            <p></p>
                        </div>
                        <textarea name="taskDescription" id="taskDescription" placeholder="Description. Say somethin" class="descriptionEdit hide"></textarea>
                    </div>
                    <div class="hideOrShow">
                        <label for="taskDescription" class="showDescription hide">
                            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24">
                        ...
                        <label for="taskDescription" class="hideDescription">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <div class="buttonWrapper">
                        <button id="saveDescription" class="hide">Save</button>
                        <button id="cancelDescription" class="hide">Cancel Changes</button>
                    </div>
                </div>
                <h4>Activity History</h4>
                <div class="activityHistory">
                    <div class="noMessage">No updates yet — start by adding a comment or making a change.</div>
            ...
            <div class="secondaryDetail">
                <div class="uploadWrapper">
                    <div class="detailWrapper2">
                        <h4 id="assignee">Assignee:</h4>
                    ...
                    <div class="uploadBox">
                        <svg class="dashed-rect" viewBox="0 0 300 150" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
                            <rect x="5" y="0" width="290" height="150"
                                rx="15" ry="15"
                                stroke-dasharray="10,5" />
                        </svg>

                        <div class="state1">
                            <svg viewBox="0 0 126 158" xmlns="http://www.w3.org/2000/svg">
                                <path d="M125 34.3034V132C125 145.807 113.807 157 100 157H26C12.1929 157 1 145.807 1 132V26C1 12.1929 12.1929 1 26 1H90.3529M125 34.3034L90.3529 1M125 34.3034H115.353C101.546 34.3034 90.3529 23.1105 90.3529 9.30336V1M30.1765 81.6292H94M62.0882 53.5843V113.18"/>
                            </svg>
                            <h4>Hustle Done? Drop Here.</h4>
                ...
                <div class="fileEditSave">
                    <div class="errorMessage"></div>
                    <button class="saveFile hide">
                        Save
                    </button>
                    <button class="cancelFileChanges hide">
                        Cancel
                    </button>
                    <button class="editFiles hide">
                        Edit
                    </button>
                </div>
                <div class="subtaskSection">
                    ...
                    <div class="progressBarWrapper">
                        ...
                        <p class="progress">99% Done</p>
                    </div>

                    <div class="subtaskTable">
                        <div class="header">
                            <div class="workAttribute attribute">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5M12 17.25h8.25" />
                                </svg>
                                Work
                            </div>
                            <div class="priorityAttribute attribute">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5M12 17.25h8.25" />
                                </svg>
                                Priority
                            </div>
                            <div class="assigneeAttribute attribute">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5M12 17.25h8.25" />
                                </svg>
                                Assignee
                        ...
                        <div class="subtaskList">
                            <div class="subtask">
                                <h4 class="work">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem, sapiente.</h4>
                                <div class="priority">
                                    <svg class="fireIcon" viewBox="0 0 21 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h4 class="status">In Progress</h4>
                            </div>
                        </div>
                    </div>

                    <div class="createSubtask hide">
                        <div class="createWrapper">
                            <input type="text" name="subtaskName" id="subtaskName" placeholder="Enter name of Subtask...">
                        ...
                        <label for="" id="errorMessage">*Error Message*</label>
                    </div>
                </div>
                <div class="parentTask">
                    <h4>Parent Task:</h4>
                    <h4 id="parentTaskTitle"></h4>
                    <label for="">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <div class="commentInput">
                    <div class="fileCardList hide"></div>
                    ...
                    <div class="buttonWrapper">
                        <div class="attachmentIcon" id="attachmentIcon">
                            <svg viewBox="0 0 168 175" xmlns="http://www.w3.org/2000/svg">
                                <path d="M43.5175 170.512L148.559 69.5704C187 26.5124 141.457 -20.1315 100.922 18.2553L21.2155 88.8194C-15.0699 121.523 15.3656 160.488 55.3533 125.072L124.296 60.1278C140.572 43.6313 121.5 28.0125 105.656 41.8608L39.375 102.646"/>
                            </svg>
                            <input type="file" name="fileInput" id="commentFileInput" hidden multiple>
                        </div>
                        <div class="sendIcon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <script>
        ...
        const selectedTaskID = <?php echo json_encode($selectedTaskID); ?>;
    ...
    <script src="6-projectGannt.js"></script>
    <script src="6-taskDetailDialog.js"></script>
</body>
</html>