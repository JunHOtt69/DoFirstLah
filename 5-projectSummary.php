...
<head>
    ...
    <link rel="stylesheet" href="5-projectSummary.css">
...
<body>
            ...
            <div class="contentHolder">
                <section class="content" id="content">
                    <div class="leftNavPanel panel">
                        ...
                        <a class="leftNavPanelItem active" href="5-projectSummary.php">
                    ...
                    <div class="rightCtnPanel">
                        <div class="upperPanel">
                            <div class="taskDueSoonPanel panel">
                                <h3>Task Due Soon</h3>
                                <div class="taskDueWrapper"></div>
                            </div>
                            <div class="projectDetailsPanel panel">
                                ...
                                <div class="projectContentWrapper">
                                    <div class="leaderWrapper">
                                        <h3>Team Leader</h3>
                                        <div class="leaderName"></div>
                                        <div class="leaderAvatar"></div>
                                    </div>
                                    <div class="projectDetails">
                                        <div class="leftWrapper">
                                            ...
                                            <h4 class="descTitle">Project Description:</h4>
                                            <p class="projectDesc"></p>
                                        </div>
                                        <div class="rightWrapper">
                                            <h4 class="activeMember">
                        ...
                        <div class="lowerPanel">
                            <div class="taskOverview panel">
                                <h3>Task Overview</h3>
                                <div class="taskOverviewWrapper">
                                    <div class="pieChart">
                                        <div class="totalTask">
                                            <p>Total Task:</p>
                                            <h1>0</h1>
                                    ...
                                    <div class="labelIndicator">
                                        <div class="doneLabel">
                                            <p class="labelName">Done:</p>
                                            <p id="value">0</p>
                                        </div>
                                        <div class="unassignedLabel">
                                            <p class="labelName">Unassigned:</p>
                                            <p id="value">0</p>
                                        </div>
                                        <div class="workingLabel">
                                            <p class="labelName">Working in Progress:</p>
                                            <p id="value">0</p>
                                        </div>
                                        <div class="overdueLabel">
                                            <p class="labelName">Overdue:</p>
                                            <p id="value">0</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="workload panel">
                                ...
                                <div class="workloadHeader">
                                    <p class="workloadItem1">Member</p>
                                    <p class="workloadItem2">Work Distribution</p>
                                </div>
                            ...
                            <div class="goal panel">
                                ...
                                <div class="goalDescription">
                                    ...
                                    <div class="dueDateWrapper">
                                        <p>Due:</p>
                                        <div class="calenderToggle" id="calendarToggle">Select Due Date</div>
                                    </div>
                                    <p>Progress:</p>
                                    <div class="progressBar"></div>
                                </div>

                                <h4>Prioritize Task</h4>
                                <div class="taskDueWrapper"></div>
                            </div>
                        </div>
                    </div>
    ...
    <dialog class="editProjectDialog">
        ...
        <div class="dialogHeader">
            <input type="text" class="projectTitleEdit" placeholder="Project Title">
            <div class="closeBtn"> &times; </div>
        </div>
        <div class="dialogContent">
            <textarea name="projectDesc" id="projectDescEdit"></textarea>
        </div>
    ...
    <script src="5-projectSummary.js"></script>
</body>
</html>