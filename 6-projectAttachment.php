...
<head>
    ...
    <link rel="stylesheet" href="6-projectAttachment.css">
    <link rel="stylesheet" href="6-filePreview.css">
...
<body>
            ...
            <div class="contentHolder">
                <section class="content" id="content">
                    <div class="leftNavPanel panel">
                        ...
                        <a class="leftNavPanelItem active" href="6-projectAttachment.php">
                    ...
                    <div class="rightCtnPanel">
                        <div class="attachmentPanel panel">
                            <h3>Attachment</h3>
                            <form action="">
                                <div class="searchBar">
                            ...
                            <div class="attachmentList">
                                <div class="attachmentWrapper"></div>
                            </div>
                        </div>
                    </div>
    ...
    <dialog class="attachmentDetail" id="attachmentDetail">
        <div class="messageWrapper">
            <div class="message"></div>
        </div>
        <div class="dialogHeader">
            <div class="attachmentDetailWrapper1">
                <div class="fileRepository"></div>
                <p class="fileSize"></p>
        ...
        <div class="attachmentPreviewWrapper">
            ...
            <div class="videoControls">
                <button class="playPause">
                    ...
                    <svg class="pause hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M6.75 5.25a.75.75 0 0 1 .75-.75H9a.75.75 0 0 1 .75.75v13.5a.75.75 0 0 1-.75.75H7.5a.75.75 0 0 1-.75-.75V5.25Zm7.5 0A.75.75 0 0 1 15 4.5h1.5a.75.75 0 0 1 .75.75v13.5a.75.75 0 0 1-.75.75H15a.75.75 0 0 1-.75-.75V5.25Z" clip-rule="evenodd" />
                    </svg>
                </button>
            </div>
            <div class="zoomTool hidden">
                <button class="zoomIn">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
                </button>
                <p class="viewRatio">100%</p>
    ...
    <script src="6-projectAttachment.js"></script>
    <script src="6-filePreview.js"></script>
